...
import CoachingBG from '../assets/images/Main-background.png'
    ...
    render() {
        ...
        return (
            <div className={`body ${this.state.loading} ${this.props.hideHomeImg ? 'light-body-bg' : ''}`}>
                ...
                {this.props.show ?<img src={CoachingBG} hidden={this.props.hideHomeImg} className='home-bg-img coaching-bg-img'/>
