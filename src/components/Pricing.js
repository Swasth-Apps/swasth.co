    ...
    return (
      <section className='feature-section-group'>
        <Row className='card-row'>
          <div className='cell'>
            <div className='well tac'>
              <h1>Invest In Your Personal Training Business</h1>
        ...
        <div className='cell well'>
          <div className='grid grid--3row well well--m mt4'>
            <div className='card card--vertical card--starter'>
              <div className='card-text'>
                <p>The Starter Plan</p>
                <h4>$19/month</h4>
              </div>
              <div className='card-content well well--s'>
                <ul>
                  <li>
                  ...
                  <li>
                    TrueCoach Payments (Coming Soon)
                  </li>
                </ul>
                <a href="https://app.truecoach.co/sign-up/" className="button button--secondary">Try Starter Free</a>
              </div>
            </div>
